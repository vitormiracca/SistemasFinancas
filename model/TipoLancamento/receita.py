...
class Receita(Lancamento):
    def __init__(self, valor:float, data_lancamento:date, data_liquidacao:date, conta:Conta, categoria:Categoria, descricao:str = ''):
        super().__init__(valor, data_lancamento, data_liquidacao, conta, TipoLancamento.RECEITA, descricao)
